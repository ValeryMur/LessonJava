...
public class ListenerSignIn extends TestListenerAdapter{
    private static Logger logger = LoggerFactory.getLogger(ListenerSignIn.class);
    ...
    public void onTestFailure(ITestResult result) {
       //File screenshotAs = ((TakesScreenshot) ((LoginVB) result.getInstance()).driver).getScreenshotAs(OutputType.FILE);
